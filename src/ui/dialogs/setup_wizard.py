...
from src.core.config import (
    APP_TITLE, ASSETS_DIR, COMPANY,
    DEFAULT_COLORS, DEFAULT_COST_PER_GRAM,
    DEFAULT_PRINTER_LIFETIME_KG, DEFAULT_PRINTER_PRICE,
    DEFAULT_SETTINGS, ELECTRICITY_RATE,
    LOGO_PATH, NOZZLE_COST, NOZZLE_LIFETIME_GRAMS,
)
